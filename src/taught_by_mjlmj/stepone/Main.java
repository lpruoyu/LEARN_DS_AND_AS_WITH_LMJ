package taught_by_mjlmj.stepone;
...
import taught_by_mjlmj.tools.FileInfo;
import taught_by_mjlmj.tools.Files;
import taught_by_mjlmj.tools.TimesAsync;
...
import taught_by_mjlmj.stepone.tree.BinarySearchTree;
import taught_by_mjlmj.stepone.tree.BinaryTree;
...
public class Main {
    ...
    private static void testTraversal() {
        ...
        binaryTree.preorderTraversal(new Tree.Visitor<Integer>() {
            @Override
        ...
        System.out.println("\n中序遍历：");
        binaryTree.inorderTraversal(new Tree.Visitor<Integer>() {
            @Override
            public void visit(Integer element) {
                System.out.print(element + " ");
            }
        ...
        System.out.println("\n后序遍历：");
        binaryTree.postorderTraversal(new Tree.Visitor<Integer>() {
            @Override
            public void visit(Integer element) {
                System.out.print(element + " ");
            }
        ...
        System.out.println("\n层序遍历：");
        binaryTree.leverOrderTraversal(new Tree.Visitor<Integer>() {
            @Override
            public void visit(Integer element) {
                System.out.print(element + " ");
            }
...
//        });
        ...
        TimesAsync.test("TreeSet", new TimesAsync.Task() {
            public void execute() {
        ...
        TimesAsync.test("HashSet", new TimesAsync.Task() {
            public void execute() {
